...
/**
 * Integration event: an agency was registered.
 * Routed to {@code tnt.agency.events}. Faithful port of the monolith event contract.
 */
public record AgencyRegistered(
        UUID eventId,
        UUID aggregateId,
        UUID tenantId,
        String agencyName,
    ...
    @Override public String getEventType()     { return "AgencyRegistered"; }
