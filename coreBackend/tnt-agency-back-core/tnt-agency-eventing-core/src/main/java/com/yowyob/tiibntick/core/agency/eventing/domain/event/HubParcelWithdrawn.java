...
/**
 * Integration event: a parcel was withdrawn from an agency relay hub.
 * Routed to {@code tnt.agency.events}.
 */
public record HubParcelWithdrawn(
        UUID eventId,
        UUID aggregateId,
        UUID tenantId,
        UUID hubId,
    ...
    @Override public String getEventType()     { return "HubParcelWithdrawn"; }
