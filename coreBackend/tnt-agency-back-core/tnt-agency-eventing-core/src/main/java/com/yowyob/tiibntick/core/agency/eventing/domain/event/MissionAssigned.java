...
/**
 * Integration event: a mission was assigned to a deliverer/vehicle.
 * Routed to {@code tnt.agency.mission.request}.
 */
public record MissionAssigned(
        UUID eventId,
        UUID aggregateId,
        UUID tenantId,
        UUID agencyId,
    ...
    @Override public String getEventType()     { return "MissionAssigned"; }
