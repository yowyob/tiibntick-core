...
## 30-second summary
TiiBnTick Core = 53-module reactive Java/Spring Boot logistics+billing platform, hexagonal architecture, built on the external Yowyob Kernel. One runnable module (`tnt-bootstrap`). Java 21, Spring Boot 4.0.6/Framework 7, WebFlux, R2DBC, Kafka, Redis, MinIO.
...
4. `architecture/modules.md` — the 53 modules, one line each
