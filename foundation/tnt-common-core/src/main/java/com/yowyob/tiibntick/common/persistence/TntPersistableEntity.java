package com.yowyob.tiibntick.common.persistence;

/**
 * Marks an R2DBC entity whose {@code @Id} is assigned client-side (e.g. via
 ...
 * Implementing {@code org.springframework.data.domain.Persistable} plus this marker lets
 * {@code TntEntityIsNewCallback} (tnt-bootstrap) flip new-ness back to {@code false} only
 * for entities actually read back from the DB.
 *
