...
import com.yowyob.tiibntick.core.platformgateway.adapter.out.persistence.entity.TntPersistableEntity;
 ...
 * read from the DB) stay "new" and correctly issue an {@code INSERT}. See
 * {@link TntPersistableEntity} for why this is needed.
 *
