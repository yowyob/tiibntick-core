...
public class TntRoleAssignmentAdminController {
    ...
    private final AssignTntRoleUseCase useCase;

    public TntRoleAssignmentAdminController(AssignTntRoleUseCase useCase) {
    ...
    public Mono<ResponseEntity<ApiResponse<TntRoleAssignmentResponse>>> assign(
        ...
        return useCase.assignRole(request.targetUserId(), request.roleCode(), request.scopeId())
